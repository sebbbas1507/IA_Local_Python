...
#Ejecuta el comando ".\venv\Scripts\Activate.ps1" en la tarminal para activar el entorno virtual, en la ruta aparecera un (venv) al inicio.
...
#En l aterminal de python con el entorno virtual activado ejecuta "pip install ollama".
